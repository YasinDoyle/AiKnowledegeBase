...
class RagController {
  ...
  async modify_rag(args: {
    ...
    ragConfig.searchStrategy =
      searchStrategy == undefined ? ragConfig.searchStrategy : searchStrategy
    ragConfig.maxRecall = maxRecall == undefined ? ragConfig.maxRecall : maxRecall
    ragConfig.recallAccuracy =
      recallAccuracy == undefined ? ragConfig.recallAccuracy : recallAccuracy
    ragConfig.resultReordering =
      resultReordering == undefined ? ragConfig.resultReordering : resultReordering
